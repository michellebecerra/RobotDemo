...
"""autogenerated by genpy from cordial_core/BehaviorActionFeedback.msg. Do not edit."""
import sys
...
class BehaviorActionFeedback(genpy.Message):
  _md5sum = "302ff2538903c64a53c5a42183670596"
  _type = "cordial_core/BehaviorActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cordial_core/BehaviorFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BehaviorActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cordial_core.msg.BehaviorFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cordial_core.msg.BehaviorFeedback()
