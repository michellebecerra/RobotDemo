...
"""autogenerated by genpy from cordial_core/PlayerActionFeedback.msg. Do not edit."""
import sys
...
class PlayerActionFeedback(genpy.Message):
  _md5sum = "604cc24d7652a1cade1fb02657dcbfc8"
  _type = "cordial_core/PlayerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cordial_core/PlayerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlayerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cordial_core.msg.PlayerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cordial_core.msg.PlayerFeedback()
