...
"""autogenerated by genpy from cordial_core/PlayerActionResult.msg. Do not edit."""
import sys
...
class PlayerActionResult(genpy.Message):
  _md5sum = "65a435cd7868313b8b6ee80ed149c241"
  _type = "cordial_core/PlayerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cordial_core/PlayerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlayerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cordial_core.msg.PlayerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cordial_core.msg.PlayerResult()
