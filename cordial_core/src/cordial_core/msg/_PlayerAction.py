...
"""autogenerated by genpy from cordial_core/PlayerAction.msg. Do not edit."""
import sys
...
class PlayerAction(genpy.Message):
  _md5sum = "101f9391745fc102665ccad61f102181"
  _type = "cordial_core/PlayerAction"
...
"""
  ...
  _slot_types = ['cordial_core/PlayerActionGoal','cordial_core/PlayerActionResult','cordial_core/PlayerActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlayerAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cordial_core.msg.PlayerActionGoal()
      if self.action_result is None:
        self.action_result = cordial_core.msg.PlayerActionResult()
      if self.action_feedback is None:
        self.action_feedback = cordial_core.msg.PlayerActionFeedback()
    else:
      self.action_goal = cordial_core.msg.PlayerActionGoal()
      self.action_result = cordial_core.msg.PlayerActionResult()
      self.action_feedback = cordial_core.msg.PlayerActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.phrase
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_goal.goal.interrupt, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.phrase = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.phrase = str[start:end]
      _x = self
      start = end
      end += 13
      (_x.action_goal.goal.interrupt, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      self.action_goal.goal.interrupt = bool(self.action_goal.goal.interrupt)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
