...
"""autogenerated by genpy from cordial_core/BehaviorActionResult.msg. Do not edit."""
import sys
...
class BehaviorActionResult(genpy.Message):
  _md5sum = "7a6335689a2acbc972d78b75d67f9f90"
  _type = "cordial_core/BehaviorActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cordial_core/BehaviorResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BehaviorActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cordial_core.msg.BehaviorResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cordial_core.msg.BehaviorResult()
