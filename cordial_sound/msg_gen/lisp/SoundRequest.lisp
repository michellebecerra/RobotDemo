...
(cl:in-package cordial_sound-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <SoundRequest>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SoundRequest)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cordial_sound-msg:<SoundRequest> is deprecated: use cordial_sound-msg:SoundRequest instead.")))

(cl:ensure-generic-function 'sound-val :lambda-list '(m))
(cl:defmethod sound-val ((m <SoundRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cordial_sound-msg:sound-val is deprecated.  Use cordial_sound-msg:sound instead.")
  (sound m))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <SoundRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cordial_sound-msg:command-val is deprecated.  Use cordial_sound-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'arg-val :lambda-list '(m))
(cl:defmethod arg-val ((m <SoundRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cordial_sound-msg:arg-val is deprecated.  Use cordial_sound-msg:arg instead.")
  (arg m))

(cl:ensure-generic-function 'arg2-val :lambda-list '(m))
(cl:defmethod arg2-val ((m <SoundRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cordial_sound-msg:arg2-val is deprecated.  Use cordial_sound-msg:arg2 instead.")
  (arg2 m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SoundRequest>)))
  ...
  "e3b4b69a05291d4df0d31497c27a5d7f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SoundRequest)))
  "Returns md5sum for a message object of type 'SoundRequest"
  "e3b4b69a05291d4df0d31497c27a5d7f")
